...
\usepackage[hyperref=true,url=false,backend=bibtex,style=numeric-comp,backref=false,firstinits=true,doi=false,eprint=true,language=USenglish,sorting=none]{biblatex}
