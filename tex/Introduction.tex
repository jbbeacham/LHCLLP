...
For particles moving close to the speed of light, this can lead to macroscopic, detectable displacements between the production and decay points of an unstable particle for $c\tau\gtrsim 10~\mu\mathrm{m}$. Recently, a comprehensive collection of theories predicting the existence of LLPs has been assembled as part of the physics case document for the proposed MATHUSLA experiment \cite{Curtin:2018mvb}. Since our focus is on the experimental signatures of LLPs, we refer the reader to this document and the vast number of references therein for the full theoretical landscape of models that include LLPs.
