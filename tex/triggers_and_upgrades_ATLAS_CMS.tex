...
While this study is optimistic in assuming that selections on timing can eliminate all backgrounds to the LLP search, it nevertheless serves as important inspiration for more detailed experimental studies to understand the precise extent of the sensitivity gain. The LLP efficiency is largely unaffected by this change, while low-mass LLPs lose sensitivity by a factor of a few.
