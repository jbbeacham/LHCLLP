...
In gauge-mediated SUSY breaking models, smuons can be (co-)NLSPs (next to lightest supersymmetric particles) and decay to a muon and a gravitino [137].
...
algorithm specifically designed for displaced muons~\cite{CMS-DP-2015-015}.
