...
available on the web page:\\ \hspace*{0.25cm} \url{https://madanalysis.irmp.ucl.ac.be/wiki/MA5LongLivedParticle}
...
%    \multirow{4}{*}{\bf SR-1}& 0.1 & 3.89   & 3.8  & 2\\
    ...
    \multirow{4}{*}{\bf SR-3}& 0.1 & 0.139  & 0.16 & 15\\
                             ...
                             & 100 & 0.497  & 0.27 & 85\\
  \end{tabular}
  \caption{Number of events populating the three signal regions (SR-1, SR-2 and SR-3) of Ref.~\cite{CMS:2016isf}
...
\noindent where information about the re-implementation in \MA\ of Ref.~\cite{CMS:2016isf}
