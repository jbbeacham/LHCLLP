...
\noindent {\bf Chapter editors:}~Juliette Alimena, Martino Borsato, Zhen Liu, Sascha Mehlhase\\
...
% -----------------------------------------------------------------------------------
\section{Real Particles Produced via Interactions with the Detector}
% -----------------------------------------------------------------------------------
