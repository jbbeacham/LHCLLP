...
\begin{figure}[t]
  ...
  \end{minipage}
  \caption{Naive sensitivity projections for searches of displaced dijet vertices at LHCb for the expected luminosity to be collected with the Phase-II upgraded detector (300\invfb) \cite{LHCb-CONF-2018-006}. The projected limit is on Higgs boson decays to dark pions $\pi_V$ with branching fraction $\mathcal{B}$, and the dark pions each in turn decay to a pair of jets.
}
